...
S3Publisher.prototype.finishedFileUpload = function(error) {
  if (error) {
...
S3Publisher.prototype.uploadFile = function(filePath, type, destination) {
  var data = fs.readFileSync(filePath);

  this.ui.write(chalk.green('Sending ' + destination + ' to S3.\n'));
  var params = {
    ACL: 'public-read',
    Body: data,
  ...
  return this.s3.putObject(params, this.finishedFileUpload.bind(this));
};
